...
public class ConsolePlayfairCipher {
...
//main() method to test Playfair method  
    ...
    public static void main(String args[]) {
        ConsolePlayfairCipher pf = new ConsolePlayfairCipher();
    }
//main run of the program, Playfair method  
//constructor of the class  

    private ConsolePlayfairCipher() {
...
//prompts user for message to be encoded  
        System.out.println("Enter the plaintext to be encipher: ");
